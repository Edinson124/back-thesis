...
public class BloodExtractionServiceImpl implements BloodExtractionService {
    ...
    public BloodExtractionServiceImpl(BloodExtractionRepository bloodExtractionRepository, BloodExtractionMapper bloodExtractionMapper, DonationService donationService) {
